...
todosSusFactoresEstanElevadosAlCuadrado(X):-X>1, esPrimo(Y), not(X<Y), X2 is X//Y, 0 is X mod Y, X3 is X2//Y,0 is X2 mod Y, todosSusFactoresEstanElevadosAlCuadrado(X3), !.
